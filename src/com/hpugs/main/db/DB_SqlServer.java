...
public class DB_SqlServer {
	...
	//数据库连接参数
	private static final String DBDRIVER = "com.microsoft.sqlserver.jdbc.SQLServerDriver";// 数据库驱动地址
	private static final String DBURL = "jdbc:sqlserver://localhost:1433;DatabaseName=hpugs";// 数据库连接地址
